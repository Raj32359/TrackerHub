    ...
    axios({
     ...
     .then((response) => {
        if (response.status === 201) {
          ...
          setFormValues({ courseName: "", courseDuration: "", professorName: "", description: "", uploadFile:"" });
        }
      })
      .catch((error) => {
          ...
          <form noValidate autoComplete="off">
            <Grid item xs={12} md={12} lg={12} sm={12} style={{display:"flex"}}>
              ...
              <Grid xs={3} md={3} lg={3} sm={3}>
                ...
                {selectedImage && (
                  <img className="previewImage" src={URL.createObjectURL(selectedImage)} alt="Thumb" />
                )}
              </Grid>
            </Grid>
